...
- (void)stop:(id)sender {
    ...
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"LLCircularProgressView" message:@"Yep, it's done. Check the dimmed colors effect." delegate:nil cancelButtonTitle:@"Done" otherButtonTitles:nil];
    [alertView show];
}
